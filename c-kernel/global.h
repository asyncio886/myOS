...
#define NULL ((void *)(0))
#define CORE_MEMORY_POS 1024 * 1024 * 1024 * 3
#define GDT_ADDR 0xc0000903
#define PAGE_TABLE_POS 0x100000
// idt描述符
struct gate_desc
{
    uint16_t func_offset_low_wrod;
    uint16_t selector;
    uint8_t dcount;
    uint8_t attribute;
